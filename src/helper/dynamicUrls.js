const baseUrl = process.env.REACT_APP_LAMBDA_URL ? process.env.REACT_APP_LAMBDA_URL  : 'https://ya3lw5g3ri.execute-api.ap-south-1.amazonaws.com/dev/v1'; // Dev env URL
...
const dynamicUrl = {
  ...
  teacherAccess: baseUrl + '/teacherAccess',
  ...
  bulkGroupsUpload:baseUrl + '/bulkGroupsUpload',
