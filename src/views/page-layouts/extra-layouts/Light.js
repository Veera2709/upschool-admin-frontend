...
const Light = () => {
  ...
  useEffect(() => {
    if (layoutType !== 'menu-light') {
      dispatch({ type: actionType.LAYOUT_TYPE, layoutType: 'menu-light' });
    }
  }, [headerBackColor, layoutType, dispatch]);
      ...
      <Row>
        <Col>
          <Card>
            ...
            <Card.Body>
              <p>
                In Light Layout - Your entire layout will be set to light colors. You can also change different colors using live
                customizer.
              </p>
