                ...
                <Tab eventKey="home" title="Home">
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={p2} alt="prod img" className="img-fluid" />
                        </td>
                        <td>PNG002344</td>
                        <td>John Deo</td>
                        <td>05-01-2017</td>
                      ...
                      <tr>
                        <td>
                          <img src={p3} alt="prod img" className="img-fluid" />
                        </td>
                        <td>PNG002653</td>
                        <td>Eugine Turner</td>
                        <td>04-01-2017</td>
                      ...
                      <tr>
                        <td>
                          <img src={p4} alt="prod img" className="img-fluid" />
                        </td>
                        <td>PNG002156</td>
                  ...
                  <div className="text-center">
                    <Button variant="outline-primary" className="btn-round btn-sm">
                      Load More
                    </Button>
                  </div>
                </Tab>
                ...
                <Tab eventKey="entertainment" title="Entertainment">
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={p1} alt="prod img" className="img-fluid" />
                        </td>
                        <td>PNG002413</td>
                        <td>Jane Elliott</td>
                        <td>06-01-2017</td>
            ...
            <Card.Body>
              <ListGroup as="ul" bsPrefix=" " className="feed-blog pl-0">
                <ListGroup.Item as="li" bsPrefix=" " className="active-feed">
                  ...
                  <h6>
                    <span className="badge badge-danger">File</span> Eddie uploaded new files:{' '}
                ...
                <ListGroup.Item as="li" bsPrefix=" " className="diactive-feed">
                  ...
                  <h6>
                    <span className="badge badge-success">Task</span> Sarah marked the Pending Review:{' '}
                ...
                <ListGroup.Item as="li" bsPrefix=" " className="diactive-feed">
                  ...
                  <h6>
                    <span className="badge badge-primary">comment</span> abc posted a task:{' '}
            ...
            <Card.Body>
              <ListGroup as="ul" bsPrefix=" " className="activity-blog pl-0">
                <ListGroup.Item as="li" bsPrefix=" ">
                  ...
                  <h6 className="m-b-0">
                    John Deo <small className="text-muted">2 hours ago</small>
                  </h6>
                  <p className="m-b-15">
                    Assign a new Task <span className="text-c-blue">Design Web Mockup</span>
                  </p>
                  ...
                  <Link to="#" className="m-r-10 text-muted">
                    <i className="fa fa-comment text-c-blue m-r-5" /> 3 Comments
                  </Link>
                  <Link to="#" className="text-muted">
                    {' '}
                    <i className="fa fa-heart text-c-red m-r-5" /> 5 Like
                  </Link>
                </ListGroup.Item>
                <ListGroup.Item as="li" bsPrefix=" ">
                  <div className="activity-user-img">
                  ...
                  <Row className="m-b-15 m-t-15">
                    ...
                    <Col sm="auto" className="col-sm-9">
                      ...
                      <Button variant="primary" className="btn-round btn-sm">
                        Design Web Mockup
                      </Button>
                    </Col>
                  </Row>
                    ...
                    <div className="row p-b-20">
                      ...
                      <div className="col p-l-5">
                        ...
                        <p className="m-b-0">
                          ...
                          <Link to="#" className="text-c-green">
                            {' '}
                            More
                          </Link>
                        </p>
                  ...
                  <div className="p-l-20 p-r-20">
                    ...
                    <div className="media col-sm-8 offset-md-4">
                      <div className="media-body receive-chat">
                        ...
                        <span className="time">
                          <i className="fas fa-check m-r-5" />
                          Seen 2 sec ago
                        </span>
                      </div>
                    </div>
            ...
            <Card.Body className="p-0">
                ...
                <PerfectScrollbar>
                  <div className="p-l-20 p-r-20">
                    ...
                    <ListGroup as="ul" bsPrefix=" " className="list-unstyled m-b-20">
                      <ListGroup.Item as="li" bsPrefix=" " className="d-inline-block">
                        <img
                          src={Avatar2}
                          style={{ width: '30px' }}
                          alt="user"
              ...
              <div className="right-icon-control m-15">
                <div className="input-group input-group-button">
                  ...
                  <div className="input-group-append">
                    <Button variant="primary" type="button">
                      <i className="feather icon-plus m-0 text-white" />
                    </Button>
                  </div>
                </div>
              </div>
                ...
                <Card.Body>
                  ...
                  <div className="row m-b-25 align-items-center">
                    ...
                    <div className="col">
                      <Link to="#">
                        <h6 className="m-b-5">
                          You have 5 pending tasks. <span className="text-muted float-right f-14">5 hours ago</span>
                        </h6>
                      </Link>
                    </div>
                  </div>
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$ 16,244</td>
                        <td>
                          <Link to="#" className=" badge badge-light-primary f-12">
                            Active
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>$ 3,937</td>
                        <td>
                          <Link to="#" className="badge badge-light-warning f-12">
                            Not Active
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>$ 28,039</td>
                        <td>
                          <Link to="#" className="badge badge-light-success f-12">
                            Paused
                          </Link>
                        </td>
                      </tr>
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$ 874.23</td>
                        <td>
                          <Link to="#" className="badge badge-light-primary">
                            Active
                          </Link>
                        </td>
                        <td className="text-right">
                      ...
                      <tr>
                        ...
                        <td>$ 235.34</td>
                        <td>
                          <Link to="#" className="badge badge-light-warning">
                            Not Active
                          </Link>
                        </td>
                        <td className="text-right">
                      ...
                      <tr>
                        ...
                        <td>$ 233.46</td>
                        <td>
                          <Link to="#" className="badge badge-light-success">
                            Active
                          </Link>
                        </td>
                        <td className="text-right">
                  ...
                  <Table responsive>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Link to="#" className="badge badge-light-primary badge-pill f-12 mr-2">
                            Reject
                          </Link>
                          <Link to="#" className="badge badge-light-success badge-pill f-12 mr-2">
                            Approve
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Link to="#" className="badge badge-light-danger badge-pill f-12 mr-2">
                            Reject
                          </Link>
                          <Link to="#" className="badge badge-light-warning badge-pill f-12 mr-2">
                            Approve
                          </Link>
                        </td>
                      </tr>
