  ...
  return (
    <React.Fragment>
      <Row>
        ...
        <Col md={6} xl={3}>
          <NotificationCard
            params={{ class: 'bg-c-yellow', icon: 'fa fa-comments', primaryText: '123', secondaryText: 'Total Messages' }}
          />
        </Col>
        <Col md={6} xl={3}>
        ...
        <Col xl={4} md={6}>
          <TaskStatusCard
            params={{
              ...
              primaryTitle: '4',
              primaryText: '15%',
              secondaryText: 'Last Month: 6'
            }}
          />
        </Col>
        <Col xl={4} md={6}>
          <WeatherLiteCard
            params={{ class: 'blue', temperature: '19', caption: 'Sunny', icon: 'feather icon-sun', location: 'New York , NY' }}
          />
        </Col>
        ...
        <Col xl={4} md={12}>
          <CompanyCard
            params={{
              title: 'Impressions',
              primaryText: '1,563',
              secondaryText: 'May 23 - June 01 (2020)',
              icon: 'fas fa-eye',
              class: 'text-c-blue',
              variant: 'primary'
            }}
        ...
        <Col xl={4} md={12}>
          <CompanyCard
            params={{
              title: 'Goal',
              primaryText: '30,564',
              secondaryText: 'May 28 - June 01 (2020)',
        ...
        <Col xl={4} md={12}>
          <CompanyCard
            params={{
              title: 'Impact',
              primaryText: '42.6%',
              secondaryText: 'May 30 - June 01 (2020)',
        ...
        <Col xl={4} md={12}>
          <ProjectCard
            params={{
              primaryTitle: 'Ticket Answered',
              secondaryTitle: 'Live Update',
              class: 'text-c-red',
              variant: 'danger',
              primaryText: '327',
              icon: 'far fa-calendar-check',
              secondaryText: '10 Days',
              badge: '53%'
            }}
          />
        </Col>
        ...
        <Col xl={4} md={12}>
          <ProjectCard
            params={{
              primaryTitle: 'Unique Innovation',
              secondaryTitle: 'Live Update',
              class: 'text-c-yellow',
              variant: 'warning',
              primaryText: '1 Month',
        ...
        <Col xl={3} md={6}>
          <TicketCard
            params={{
              badgeText: 'Open Tickets',
              badgeIcon: 'fas fa-folder-open',
              class: 'text-c-red',
              variant: 'danger',
              primaryText: '128',
        ...
        <Col xl={3} md={6}>
          <TicketCard
            params={{
              badgeText: 'Close Tickets',
              badgeIcon: 'fas fa-file-archive',
              class: 'text-c-blue',
              variant: 'primary',
              primaryText: '134',
              secondaryText: 'Tickets',
        ...
        <Col xl={4} md={12}>
          <AnalyticCard
            params={{
              class: 'red',
              badgeIcon: 'fas fa-file-code',
              icon: 'fas fa-caret-down',
              primaryTitle: '15,678',
              secondaryTitle: 'Total Project',
            ...
            <Col xl={8} lg={12}>
              <SeoCard
                params={{
                  ...
                  class: 'bg-c-blue',
                  title: 'Traffic',
                  primaryText: 'Devices and resolution',
                  secondaryText:
                ...
                <Col sm={12}>
                  <SeoCard
                    params={{
                      ...
                      title: (
                        <React.Fragment>
                          <i className="fa fa-caret-up text-c-green m-r-10" /> +52%
                        </React.Fragment>
                      ),
                      primaryText: 'New Users',
                      secondaryText: 'Calculated in 7 days'
                    }}
                  />
                </Col>
                <Col sm={12}>
                  <SeoCard
                    params={{
                      ...
                      title: (
                        <React.Fragment>
                          <i className="fa fa-caret-down text-c-red m-r-10" /> -82%
                        </React.Fragment>
                      ),
                      primaryText: 'Bounce Rate',
                      secondaryText: 'Calculated in 7 days'
                    }}
                  />
                </Col>
