              ...
              <Row>
                <Col>
                  ...
                  <div className="m-t-30">
                    <Link to="#" className="text-underline text-c-blue">
                      <small>Previous Quarters</small>
                    </Link>
                  </div>
                </Col>
                <Col>
            ...
            <Card.Body className="pb-0">
              ...
              <Row>
                <Col sm="auto">
                  <h3>$687,578</h3>
                  <h6>
                    <i className="feather icon-trending-down text-c-red mr-2" />
                    Marketing Growth
                  </h6>
                  <span>
                    Measure How Fast You're Growing in
                    <br />
                    current Market.<span className="text-c-blue">Learn More</span>
                  </span>
                </Col>
                <Col>
                  <h3>30%</h3>
                  <h6>
                    <i className="feather icon-trending-up text-c-blue mr-2" />
                    Annual profit/stakeholders
                  </h6>
                  <span>
                    Ave 30% or more profite provide to investor as
                    <br />
                    Anual return.<span className="text-c-blue">Learn More</span>
                  </span>
                </Col>
              </Row>
            </Card.Body>
                  ...
                  <Row className="d-flex align-items-center">
                    <Col className="pr-0">
                      <span className="d-block mb-1">
                        <i className="fas fa-circle f-10 m-r-5 text-primary" />
                        Desktop [66.6%]
                      </span>
                      <span className="d-block mb-1">
                      ...
                      <span className="d-block">
                        <i className="fas fa-circle f-10 m-r-5 text-warning" />
                        Tablet [38.6%]
                      </span>
                    </Col>
                    <Col>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <span>
                It takes continuous effort to maintain high customer satisfaction levels.Internal and external quality measures are often
                tied together.,as the opinion...
              </span>
          ...
          <Card>
            <Card.Body>
              ...
              <Row className="mt-4 text-center">
                ...
                <Col>
                  <h3 className="m-0">
                    <i className="fas fa-circle text-c-blue f-10 m-r-5 text-success" />
                    182
                  </h3>
                ...
                <Col>
                  <h3 className="m-0">
                    <i className="fas fa-circle text-c-purple f-10 m-r-5 text-danger" />
                    768
                  </h3>
