      ...
      <Row>
        ...
        <Col sm={12} md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                Use font-awesome icons in <code>emptySymbol</code> and <code>fullSymbol</code> with component <code>Rating</code> to see
                font awesome rating.
              </Card.Text>
        ...
        <Col sm={12} md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                Use feather icons in <code>emptySymbol</code> and <code>fullSymbol</code> with component <code>Rating</code> to see feather
                rating.
              </Card.Text>
              <Rating
            ...
            <Card.Body>
              ...
              <div className="reverse-rating">
                <Rating
                  ...
                  onHover={(rate) =>
                    (document.getElementById('reverse-rating').innerHTML = reverseRate[rate - 1] || reverseRate[reverseRating - 1])
                  }
                />
              </div>
        ...
        <Col sm={12} md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                Use <code>className='theme-bar-horizontal'</code> with component <code>Rating</code> to see horizontal rating.
              </Card.Text>
