      ...
      <Row>
        <Col>
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                Use our powerful mobile-first flexbox grid to build layouts of all shapes and sizes thanks to a twelve column system, five
                default responsive tiers, Sass variables and mixins, and dozens of predefined classes.
              </Card.Text>
              <h5>How it works</h5>
              <hr />
              <Card.Text>
              ...
              <Card.Text>
                ...
                grid classes. Those columns are centered in the page with the parent <code>Container</code>.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                While Bootstrap uses <code className="highlighter-rouge">em</code>s or <code className="highlighter-rouge">rem</code>s for
                defining most sizes, <code className="highlighter-rouge">px</code>s are used for grid breakpoints and container widths. This
                is because the viewport width is in pixels and does not change with the{' '}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                <code className="highlighter-rouge">xs</code> to <code className="highlighter-rouge">xl</code>. Add any number of unit-less
              ...
              <Card.Text>
                ...
                that prevented this from working without an explicit <code className="highlighter-rouge">flex-basis</code> or{' '}
                <code className="highlighter-rouge">border</code>. There are workarounds for older browser versions, but they shouldn’t be
                necessary if you’re up-to-date.
              </Card.Text>
              <Card.Text>
                Create equal-width columns that span multiple rows by inserting a <code className="highlighter-rouge">.w-100</code> where
                you want the columns to break to a new line. Make the breaks responsive by mixing the{' '}
                <code className="hlighter-rouge">.w-100</code> with some <Link to='#"'>responsive display utilities</Link>.
              </Card.Text>
              ...
              <hr />
              <Card.Text>
                Set the column value (for any breakpoint size) to <code>"auto"</code> to size columns based on the natural width of their
                content.
              </Card.Text>
              <div className="bd-example-row">
                <Container>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                Bootstrap’s grid includes five tiers of predefined classes for building complex responsive layouts. Customize the size of
              ...
              <hr />
              <Card.Text>
                For every breakpoint, you can specify the amount of columns to span, or set the prop to <code>Col with lg=true</code> for
                auto layout widths.
              </Card.Text>
              <div className="bd-example-row">
                <Container>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Text>
                For offsetting grid columns you can set an <code>`offset`</code> value, or, for more general layout, use the margin class
                utilities.
              </Card.Text>
              <div className="bd-example-row">
                <Container>
