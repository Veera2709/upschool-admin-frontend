          ...
          <Card className="bg-pattern">
            <Card.Header className="py-5 text-center">
              <h2 className="text-center mb-4">
                <span className="text-primary">Crypto</span> The <span className="text-primary">Revolution</span> In Crypto Market
              </h2>
          ...
          <Card className="bg-pattern">
            <Card.Body className="py-5 text-center">
              ...
              <div className="row align-items-end">
                ...
                <div className="col-sm-2">
                  <div className="badge badge-pill badge-danger m-b-5">bonus</div>
                  <p>7%</p>
                </div>
                <div className="col-sm-2">
                  <p>Last-chance!</p>
              ...
              <div className="progress mb-4 hei-40">
                ...
                />
                <div
                  className="progress-bar bg-danger active-progress"
                  role="progressbar"
                  style={{ width: '16.66%' }}
                  aria-valuenow="16.66"
                  aria-valuemin="0"
