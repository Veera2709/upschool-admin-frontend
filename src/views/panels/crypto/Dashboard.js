                ...
                <Card.Body>
                  ...
                  <div className="form-group fill mb-5">
                    ...
                    <input
                      ...
                      defaultValue="2xsD12F42xvR2deD42xsD12F"
                    />
                  </div>
                  ...
                  <div className="form-group fill mb-5">
                    ...
                    <input
                      ...
                      id="text2"
                      aria-describedby="emailHelp"
                      defaultValue="sD12F42xvR2de2xsD12F42xv"
                    />
                  </div>
                  <Link to="#" className="btn btn-success btn-sl-sm">
                    Settings
                  </Link>
                  <Link to="#" className="btn btn-outline-success btn-sl-sm">
                    View All
                  </Link>
                </Card.Body>
              </Card>
              ...
              <Card>
                ...
                <Card.Body>
                  <div className="input-group input-group-prepend-big mb-4">
                    ...
                    <input
                      type="text"
                      className="form-control h-auto pl-5"
                      aria-label="Text input with dropdown button"
                      placeholder="0.25"
                    />
                  </div>
