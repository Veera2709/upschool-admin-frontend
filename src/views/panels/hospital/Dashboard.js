    ...
    <React.Fragment>
      <Row>
          ...
          <Card>
            <Card.Body>
              <Row className="align-items-center m-l-0">
                <Col sm="auto">
                  <i className="fas fa-user-md f-36 text-c-yellow" />
                </Col>
                <Col sm="auto">
        ...
        <Col xl={3} md={6}>
          <Card>
            <Card.Body>
              <Row className="align-items-center m-l-0">
                <Col sm="auto">
                  <i className="fas fa-ambulance f-36 text-c-green" />
                </Col>
                <Col sm="auto">
        ...
        <Col xl={3} md={6}>
          <Card>
            <Card.Body>
              <Row className="align-items-center m-l-0">
                <Col sm="auto">
                  <i className="fas fa-pills f-36 text-c-green" />
                </Col>
                <Col sm="auto">
        ...
        <Col md={12} lg={4}>
          <Card className="borderless">
            <Card.Body className="text-center">
              <i className="fas fa-skull-crossbones text-c-green d-block f-40" />
              <h4 className="m-t-20 m-b-20">
        ...
        <Col md={12} lg={4}>
          <Card className="borderless">
            <Card.Body className="text-center">
              <i className="fas fa-baby text-c-red d-block f-40" />
              <h4 className="m-t-20 m-b-20">
