                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group fill">
                                            ...
                                            <Form.Check type='checkbox' id={`default-checkbox`} label={`Same as Business Address`} checked={copy} onClick={() => {
                                                setFieldValue('contact_name2', contactNameRef.current.value)
                                                setFieldValue('address_line1_2', addressLine1Ref.current.value)
                                                setFieldValue('address_line2_2', addressLine2Ref.current.value)
                                                setFieldValue('city2', cityRef.current.value)
                                                setFieldValue('pincode2', pincodeRef.current.value)
                                                setFieldValue('phoneNumber2', phoneNumberRef.current.value)
