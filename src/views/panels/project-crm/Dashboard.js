...
import { Row, Col, Card, ProgressBar, Alert, Tabs, Tab, Table } from 'react-bootstrap';
              ...
              <Row className="align-items-center">
                <Col>
                  <label className="badge badge-light-primary">
                    28% <i className="m-l-10 feather icon-arrow-up" />
                  </label>
                </Col>
                <Col className="text-right">
              ...
              <Row className="align-items-center">
                <Col>
                  <label className="badge badge-light-danger">
                    87% <i className="m-l-10 feather icon-arrow-up" />
                  </label>
                </Col>
                <Col className="text-right">
                  <h5 className="">6 / 6</h5>
              ...
              <Row className="align-items-center">
                <Col>
                  <label className="badge badge-light-warning">
                    32% <i className="m-l-10 feather icon-arrow-up" />
                  </label>
                </Col>
                <Col className="text-right">
              ...
              <Tabs defaultActiveKey="my-task" className="p-20">
                ...
                <Tab eventKey="my-project" title="My Projects">
                  ...
                  <div className="text-right m-r-20">
                    <Link to="#" className=" b-b-primary text-primary">
                      View all Projects
                    </Link>
                  </div>
                </Tab>
              ...
              <div className="review-block">
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <Link to="#" className="m-r-30 text-muted">
