...
import Gallery from '../../../components/Gallery/TicketGallery';
...
const TicketList = () => {
  ...
  return (
    <React.Fragment>
                  ...
                  <div className="row align-items-center">
                      ...
                      <div className="card-body inner-center">
                        ...
                        <div className="excerpt mt-4">
                          <h6>
                            ...
                            Last comment from <Link to="#">Robert alia:</Link>
                          </h6>
                          <p>
                            hello John lui, you need to create "toolbar-options" div only once in a page&nbsp;in your code, this div fill
                            found every "td" tag in your page, just remove those things. and also in option button add
                          </p>
                        </div>
                        <div className="mt-2">
                          <Link to="#" className="mr-3 text-muted">
                    ...
                    <div className="col-auto pl-0 right-icon">
                      <div className="card-body">
                        <ul className="list-unstyled mb-0">
                          ...
                          <li>
                            <Link to="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">
                    ...
                    <div className="col-auto hover-blk position-absolute shadow-sm rounded">
                      <div className="card-body p-0 pt-2">
                        ...
                        <p>
                          hello Yogen dra,you need to create "toolbar-options" div only once in a page in your code, this div fill found
                          every "td"...
                        </p>
                      </div>
                    </div>
                ...
                <div className="cat-list">
                  <div className="border-bottom pb-3 ">
                    ...
                    <div className="float-right span-content">
                      ...
                      <Link
                        to="#"
                        className="btn waves-effect waves-light btn-default badge-secondary rounded-circle mr-0 "
                        data-toggle="tooltip"
                        data-placement="top"
                        title=""
                        data-original-title="tooltip on top"
      ...
      <div className={isOpen ? queViewActive : queView}>
                ...
                <Row>
                  ...
                  <Col>
                    ...
                    <p className="text-danger">
                      <span className="font-weight-bold mr-1">Note!</span>This ticket is closed. If you want to re-open it, just post a
                      reply below.
                    </p>
                    ...
                    <div className="btn-block mt-3">
                      <Dropdown className="btn-group mb-2 mr-2">
                        ...
                        <Dropdown.Menu className="dropdown-menu">
                          <Link className="dropdown-item" as={Link} to="#">
                            Action
                          </Link>
                          <Link className="dropdown-item" as={Link} to="#">
                            Another action
