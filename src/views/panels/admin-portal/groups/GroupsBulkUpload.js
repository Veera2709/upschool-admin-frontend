...
import { bulkUpload } from '../users/user-bulk-upload-api/bulkUpload';
import useFullPageLoader from '../../../../helper/useFullPageLoader';
import { isEmptyArray } from '../../../../util/utils';


const GroupsBulkUpload = ({ className, ...rest }) => {
    ...
    if (uploadResponse.Error) {
      ...
      if (Array.isArray(uploadParams)) {
        ...
        if (Array.isArray(filePaths)) {
          ...
          const uploadResponse2 = await defaultPostApi(dynamicUrl.bulkGroupsUpload, bulkUploadPayload);
...
export default GroupsBulkUpload;
