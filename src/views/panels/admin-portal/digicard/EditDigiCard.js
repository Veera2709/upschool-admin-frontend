...
const EditDigiCard = () => {
    ...
    const [docPrev, setDocPrev] = useState(true)
                                ...
                                {({ errors, handleBlur, handleChange, handleSubmit, touched, values }) => (
                                    <form noValidate onSubmit={handleSubmit}>
                                        <Row>
                                            ...
                                            {/* <DocViewer documents={docs} pluginRenderers={DocViewerRenderers} style={{width: 200, height: 200}}/> */}
                                                ...
                                                <div className="form-group fill">
                                                    ...
                                                    <InputGroup>
                                                        <input
                                                            ...
                                                            // value={individualDigiCardData.digicard_document}
                                                            onBlur={handleBlur}
                                                    ...
                                                    { selectedFile === null && <a href={individualDigiCardData[0].digicard_documentURL} target="_blank" >Click here to see Document</a> }
