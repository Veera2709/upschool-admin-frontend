...
const ViewBluePrint = () => {
    ...
    const getIndividualData = () => {
        ...
        axios
            .post(dynamicUrl.fetchIndividualBluePrint, {
                "data": {
            ...
            .then((response) => {
                ...
                setIndividualBluePrintData(response.data[0]);
                setBluePrintData(response.data[0].sections);
                getAllRequiredData();

                { console.log("individualBluePrintData : ", individualBluePrintData) }
    ...
    useEffect(() => {
        ...
        if (userJWT === "" || userJWT === undefined || userJWT === "undefined" || userJWT === null) {
            ...
            if (threadLinks.length === 2) {
                ...
                //                 .then(data => {
                //                     setIndividualBluePrintData(data);
                //                 })
    ...
    return (
        ...
        <>  {console.log(sectionData)}
            {
                individualBluePrintData.length === 0 || individualBluePrintData.length === "0" ? <></> : (
                    <>
