...
import ImageZoom from '../../../components/Gallery/ImageZoom';
              ...
              <Row>
                  ...
                  <div id="carouselExampleCaptions" className="carousel slide carousel-fade">
                    ...
                    <ol className="carousel-indicators position-relative">
                      <li
                        ...
                        data-slide-to="0"
                        onClick={() => setIsOpen(1)}
                        className={isOpen === 1 ? productClassActive : productClass}
                      >
                      ...
                      <li
                        ...
                        data-slide-to="1"
                        onClick={() => setIsOpen(2)}
                        className={isOpen === 2 ? productClassActive : productClass}
                      >
                      ...
                      <li
                        ...
                        data-slide-to="2"
                        onClick={() => setIsOpen(3)}
                        className={isOpen === 3 ? productClassActive : productClass}
                      >
                      ...
                      <li
                        ...
                        data-slide-to="3"
                        onClick={() => setIsOpen(4)}
                        className={isOpen === 4 ? productClassActive : productClass}
                      >
                      ...
                      <li
                        ...
                        data-slide-to="4"
                        onClick={() => setIsOpen(5)}
                        className={isOpen === 5 ? productClassActive : productClass}
                      >
                ...
                <Col lg={12}>
                  <div className="mt-4">
                    <h6>Description:</h6>
                    <p>
                      This stylish Sling Bag SAHAL FASHION from is best to carry to work to add an element of style to your office wear.Made
                      from premium. It is compact to store your important things with ease.Made From outer material PU and inner material
                      From Fabric. Furthermore, they feature Turnlock closure are best suited for a casual and partywear occasion.
                    </p>
                    <div className="w-100">
                    ...
                    <h6>
                      <Link to="#">Manufacturing, Packaging and Import Info</Link>
                    </h6>
                  </div>
                </Col>
              </Row>
