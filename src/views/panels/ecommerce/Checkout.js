                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <div className="text-sm-right">
                          <Link to="#" className="btn btn-danger text-sm-right mt-md-0 mt-2" onClick={() => setAccordionKey(2)}>
                ...
                <Card>
                  ...
                  <Card.Body className="card-body">
                    <Row>
                      ...
                      <Col md={12}>
                        ...
                        <div
                          ...
                          data-toggle="tooltip"
                          title="Estimated 5-7 days shipping (Duties and tax may be due upon delivery)"
                        >
                          <input
                            type="radio"
                        ...
                        <div
                          className="custom-control custom-radio custom-control-inline"
                          data-toggle="tooltip"
                          title="Estimated 1-2 days shipping (Duties and tax may be due upon delivery)"
                        >
                    ...
                    <div className="row mt-4">
                      ...
                      <div className="col-sm-6">
                        <div className="text-sm-right">
                          <Link to="#" className="btn btn-danger text-sm-right mt-md-0 mt-2">
                            Continue to Payment
                          </Link>
                        </div>
                      </div>
                    ...
                    <Card.Header>
                      <div className="custom-control custom-radio">
                        <input
                          type="radio"
                          id="BillingPaypal"
                          onClick={() => setAccordionKey((prevState) => (prevState !== 1 ? 1 : 0))}
                          name="billingOptions"
                          className="custom-control-input"
                    ...
                    <Card.Header>
                      <div className="custom-control custom-radio">
                        <input
                          type="radio"
                          id="BillingCard"
                          onClick={() => setAccordionKey((prevState) => (prevState !== 2 ? 2 : 0))}
                          name="billingOptions"
                          className="custom-control-input"
                    ...
                    <Card.Header>
                      <div className="custom-control custom-radio">
                        <input
                          type="radio"
                          id="BillingOptRadio3"
                          onClick={() => setAccordionKey((prevState) => (prevState !== 3 ? 3 : 0))}
                          name="billingOptions"
                          className="custom-control-input"
                          aria-controls="accordion1"
                        />
                      ...
                      <div id="accordion1">
                        <Card.Body>
                          <Row>
                            <Col sm={8}>
                              <p className="mb-0 pl-3 pt-1">
                                You will be redirected to CC Avenue website to complete your purchase securely.
                              </p>
                            </Col>
                            <Col sm={4} className="text-sm-right mt-3 mt-sm-0">
                    ...
                    <Card.Header>
                      <div className="custom-control custom-radio">
                        <input
                          type="radio"
                          id="BillingOptRadio4"
                          onClick={() => setAccordionKey((prevState) => (prevState !== 4 ? 4 : 0))}
                          name="billingOptions"
                          className="custom-control-input"
                          aria-controls="accordion1"
                        />
                        ...
                        <div className="col">
                          <div className="custom-control custom-radio">
                            <input
                              type="radio"
                              id="BillingOptRadio5"
                              onClick={() => setAccordionKey((prevState) => (prevState !== 5 ? 5 : 0))}
                              name="billingOptions"
                              className="custom-control-input"
                              aria-controls="accordion1"
                              disabled
