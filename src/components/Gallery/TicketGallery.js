    ...
    if (itemType === 'images') {
      ...
      if (singleItem) {
        gallery = images
          ...
          .map((obj, i) => {
            return (
              <a href={obj.src} className={css(classes.thumbnail, classes[obj.orientation])} onClick={(e) => openLightbox(e, i)} key={i}>
          ...
          .map((obj, i) => {
            return (
              <Col xl={2} lg={3} md={4} sm={6} xs={6} key={i} className="mb-1">
                <a href={obj.src} className={css(classes.thumbnail, classes[obj.orientation])} onClick={(e) => openLightbox(e, i)}>
                  <div className="img-thumbnail">
                    <img src={obj.thumbnail} className={css(classes.source)} alt="" />
                  </div>
                </a>
